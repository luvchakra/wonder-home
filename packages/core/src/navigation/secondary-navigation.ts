...
export const SECONDARY_NAVIGATION: readonly SecondaryNavItem[] = [
  ...
  { key: "groceries", label: "Groceries", href: "/groceries", icon: "shopping-basket", tone: "care", purpose: "Never run out again", requires: null, adultOnly: true, group: "food" },
  { key: "meals", label: "Meals & Recipes", href: "/meals", icon: "utensils", tone: "meals", purpose: "Healthy meals, happier moods", requires: null, group: "food" },
  { key: "bills", label: "Bills & Finance", href: "/bills", icon: "wallet", tone: "money", purpose: "Stay on top", requires: ["finance.view"], group: "food" },
  { key: "upkeep", label: "Home & Upkeep", href: "/household/home", icon: "wrench", tone: "home", purpose: "Maintenance, laundry and pets", requires: null, adultOnly: true, group: "home" },
