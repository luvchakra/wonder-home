...
export const PERMISSIONS = {
  ...
  "health.manage": "Use the health domain — see and record health information one is authorized to see",
...
const ROLE_DEFAULTS: Record<HouseholdRole, readonly Permission[]> = {
  ...
  adult: ["finance.view", "school.manage", "health.manage", "conversation.private"],
