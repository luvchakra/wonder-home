...
- set_reminder: remind the speaker themself about something at a time ("remind me to buy them tomorrow"). parameters.what is what to be reminded of, in the speaker's words; parameters.when the day, part of the day or moment exactly as said ("tomorrow", "this evening", "tomorrow morning", "tonight", "later today", "in 2 hours", "on my way home") — never left inside what; parameters.time a time of day if said.
