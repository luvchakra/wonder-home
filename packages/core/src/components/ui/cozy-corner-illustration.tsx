...
export function CozyCornerIllustration({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 900 300" preserveAspectRatio="xMinYMid slice" className={className} aria-hidden>
      ...
      <path d="M372 196 q 12 8 24 0" stroke="oklch(0.4 0.03 60)" strokeWidth="3" fill="none" strokeLinecap="round" />
      <path d="M416 196 q 12 8 24 0" stroke="oklch(0.4 0.03 60)" strokeWidth="3" fill="none" strokeLinecap="round" />
      <path d="M392 212 q 4 4 8 0" stroke="oklch(0.4 0.03 60)" strokeWidth="2.5" fill="none" strokeLinecap="round" />
