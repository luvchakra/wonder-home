...
const snapshot: BrainSnapshot = {
  ...
  schoolItems: [
    { id: "s1", childMemberId: "anaya", kind: "homework", title: "Fractions worksheet", subject: "Maths", dueAt: new Date("2026-09-22T03:30:00Z"), estimatedMinutes: 30, estimateSource: "inferred", status: "pending", completedAt: null, provider: null, externalId: null },
  ],
  communications: [],
