...
const READY: Item[] = [
  {
    ...
    copy: "Ask in English, हिन्दी, मराठी and more. Names, dates and amounts are checked word for word before an answer reaches you.",
  },
  {
    icon: Paperclip,
    tone: "primary",
    title: "Send it, don't type it",
    copy: "A photo of a school notice, a bill PDF, a link or a voice note. WonderHome reads it and waits for your yes.",
  },
  {
    icon: BellRing,
    tone: "attention",
    title: "One nudge, not ten",
    copy: "A child's school things due the same day arrive as one reminder. The backup hears only if nobody answered.",
  },
  {
    icon: Wand2,
    tone: "care",
    title: "Set up in minutes",
    copy: "A guided start builds your household — people, routines and who looks after what — and you can pick it up later.",
  },
  {
    icon: Activity,
    tone: "health",
    title: "Health for the whole family",
    copy: "Check-ups, vitals and routines in one private place, visible only to the people who should see them.",
  },
  {
    icon: Scale,
    tone: "people",
    title: "Share the load, fairly",
    copy: "See who carries what, and hand things over before one person carries all of it.",
  },
  {
    icon: Receipt,
    tone: "money",
    title: "Receipts become history",
    copy: "Snap a shop receipt and each item you keep lands in your purchase history, ready for the next list.",
  },
  {
    icon: CalendarCheck2,
    tone: "home",
    title: "Settings, finally in one place",
    copy: "Language, reminders, voice, privacy and your plan — each with one home, so nothing disagrees with itself.",
  },
];
